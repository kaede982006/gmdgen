...
Auto-training means local context preparation from user-supplied dataset files. It is not remote fine-tuning.

The release keeps dataset empty so users can add their own data.
