...
- ai_provider=Gemini
- Gemini_model=gmdgen-coder-final
- Gemini_base_url=http://https://generativelanguage.googleapis.com
- Gemini_timeout_seconds=60
- cache_ai_responses=true
- max_ai_calls_per_generation=2

Legacy external-provider settings are not runtime configuration for this release.
