...
Generation errors should be classified clearly. Provider output must pass JSON extraction, schema validation, repair, validation, QualityGate, and SaveResult.
