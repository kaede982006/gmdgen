...
Output bundles may contain generated .gmd results, validation summaries, quality reports, and debug information. Generated caches and local user data should not be committed.
